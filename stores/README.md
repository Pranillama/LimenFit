...
| Settings client wiring  | T15 — ticket:75146556-4dd0-418c-9f5e-1d0fc95d0981/7141e09e-62ad-4c3c-96df-1fe6fd9df4b2 — `settings` slice lives on `useActiveWorkoutStore`; use `selectWeightUnit` / `selectRestTimerDefaultSeconds` / `setUserSettings`. |
